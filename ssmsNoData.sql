...
CREATE TABLE `score` (
  ...
  `chineseScore` varchar(20) DEFAULT NULL,
  `mathScore` varchar(20) DEFAULT NULL,
  `englishScore` varchar(20) DEFAULT NULL,
...
INSERT INTO `user` VALUES ('necde','123456','Neco Deng'),('necde123','950514xm','张三');
...
-- Dump completed on 2019-12-30  0:42:51
